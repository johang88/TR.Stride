...
{
    public static partial class AtmosphereRenderSkyCommonKeys
    {
        ...
        public static readonly ObjectParameterKey<Texture> ViewDepthTexture = ParameterKeys.NewObject<Texture>();
