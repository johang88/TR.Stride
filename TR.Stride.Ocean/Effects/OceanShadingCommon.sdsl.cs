...
namespace TR.Stride.Ocean
{
    public static partial class OceanShadingCommonKeys
    {
        ...
        public static readonly ValueParameterKey<float> RefractionStrength = ParameterKeys.NewValue<float>(0);
        public static readonly ValueParameterKey<float> RefractionDistanceMultiplier = ParameterKeys.NewValue<float>(0);
