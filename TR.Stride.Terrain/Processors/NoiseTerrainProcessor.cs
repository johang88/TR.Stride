...
public class NoiseTerrainProcessor : EntityProcessor<NoiseTerrainComponent, NoiseTerrainRenderData>, IEntityComponentRenderProcessor
{
	public VisibilityGroup VisibilityGroup { get; set; }

	protected override NoiseTerrainRenderData GenerateComponentData([NotNull] Entity entity, [NotNull] NoiseTerrainComponent component)
	{
		return new NoiseTerrainRenderData();
	}

	private void DestroyMesh(NoiseTerrainRenderData data)
	{
	...
	protected override void OnEntityComponentRemoved(Entity entity, [NotNull] NoiseTerrainComponent component, [NotNull] NoiseTerrainRenderData data)
	{
	...
	public override void Draw(RenderContext context)
	{
		...
		foreach (var pair in ComponentDatas)
		{
			...
			if (component.Material == null || component.NoiseData == null || component.Size <= 0.0f || component.Material.Passes.Count == 0)
			{
				DestroyMesh(data);
				continue;
			}
			...
			if (data.IsDirty(component) || component.NoiseData.NoiseSettings.DataChanged)
			{
				component.NoiseData.NoiseSettings.DataChanged = false;
				data.Update(component);

				DestroyMesh(data);

				data.Mesh = CreateMeshFromHeightMap(graphicsDevice, component.Size, component);
	...
	/// <param name="noiseComponent"></param>
	/// <returns></returns>
	private Mesh CreateMeshFromHeightMap(GraphicsDevice graphicsDevice, float size, NoiseTerrainComponent noiseComponent)
	{
		var tessellationX = noiseComponent.NoiseData.Size.X;
		var tessellationY = noiseComponent.NoiseData.Size.Y;
		...
		for (var y = 0; y < (tessellationY + 1); y++)
		{
			...
			{
				var height = noiseComponent.NoiseData.GetHeight(x, y);

				var position = new Vector3(-size + deltaX * x, height, -size + deltaY * y);
				var normal = noiseComponent.NoiseData.GetNormal(x, y);
				var tangent = noiseComponent.NoiseData.GetTangent(x, y);
...
public class NoiseTerrainRenderData
{
	public float Size { get; set; }
	public Material Material { get; set; }
	public NoiseTerrainSettings NoiseData { get; set; }
	public Mesh Mesh { get; set; }
	public ModelComponent ModelComponent { get; set; } = new ModelComponent();

	public NoiseTerrainRenderData()
	{
	...
	public void Update(NoiseTerrainComponent component)
	{
		Size = component.Size;
		Material = component.Material;
		NoiseData = component.NoiseData;
	}

	public bool IsDirty(NoiseTerrainComponent component)
		=> Material != component.Material || Size != component.Size || NoiseData != component.NoiseData || Mesh == null;
}
